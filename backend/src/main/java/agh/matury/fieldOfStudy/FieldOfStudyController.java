...
public class FieldOfStudyController {
    ...
    @Operation(summary = "Get all fields of study.", description = "Returns a paginated list of all fields of study.")
    @ApiResponse(
            responseCode = "200",
            description = "Successfully retrieved fields of study",
    ...
    public ResponseEntity<Page<FieldOfStudyDTO>> getAllFieldsOdStudy(
        ...
        return ResponseEntity.ok(fieldOfStudyService.getAllFieldsOfStudy(pageable));
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successfully retrieved field of study",
                    content = @Content(schema = @Schema(implementation = FieldOfStudyDTO.class))
            ),
            @ApiResponse(
                    responseCode = "404",
                    description = "Field of study not found",
                    content = @Content
            )
    })
    @GetMapping("/{id}")
